...
fn convert_keycode(code: VirtualKeyCode, keymod: ModifiersState) -> Option<Input> {
    ...
    let input = match code {
        ...
        VirtualKeyCode::Equals => Input::Char('='),
        VirtualKeyCode::Backslash => Input::Char('\\'),
        VirtualKeyCode::Grave => Input::Char('`'),
        VirtualKeyCode::Apostrophe => Input::Char('\''),
        VirtualKeyCode::LBracket => Input::Char('['),
        VirtualKeyCode::RBracket => Input::Char(']'),
