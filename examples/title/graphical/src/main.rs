...
use prototty_graphical::prototty_input::{keys, Input};
use prototty_graphical::Size;
use prototty_title::*;
...
fn main() {
    ...
    let mut context = prototty_graphical::ContextBuilder::new_with_font(include_bytes!("Hack-Regular.ttf"))
