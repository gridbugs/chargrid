...
pub fn from_js_event(event_key_code: u8, event_key_modifiers: u8) -> Option<Input> {
    ...
    match event_key_code {
        ...
        48 => convert_char_shift!('1', '!', shift),
        49 => convert_char_shift!('2', '@', shift),
        50 => convert_char_shift!('3', '#', shift),
        51 => convert_char_shift!('4', '$', shift),
        52 => convert_char_shift!('5', '%', shift),
        53 => convert_char_shift!('6', '^', shift),
        54 => convert_char_shift!('7', '&', shift),
        55 => convert_char_shift!('8', '*', shift),
        56 => convert_char_shift!('9', '(', shift),
        57 => convert_char_shift!('0', ')', shift),
