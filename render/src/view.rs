...
fn blend_cell_background_relative_to_draw<F: ?Sized + Frame, C: ColModify, B: Blend>(
    ...
    if relative_coord.is_valid(context.size) {
        ...
        if let Some(modified_rgb24) = context.col_modify.background(Some(rgb24)) {
            frame.blend_cell_background_absolute(
                absolute_coord,
                absolute_depth,
                modified_rgb24,
                alpha,
...
pub trait Frame {
    ...
    fn blend_cell_background_relative<C: ColModify, B: Blend>(
        ...
        blend_cell_background_relative_to_draw(
            self,
            relative_coord,
            relative_depth,
            rgb24,
...
pub fn measure_size_and_draw<V, T, C, F>(
    view: &mut V,
    data: T,
    context: ViewContext<C>,
    frame: &mut F,
    ...
    D: Frame,
{
    fn set_cell_relative<C: ColModify>(
        ...
        self.measure_bounds.set_cell_relative(
            relative_coord,
            relative_depth,
            relative_cell,
            context,
    ...
    fn blend_cell_background_relative<C: ColModify, B: Blend>(
        ...
        self.draw.blend_cell_background_relative(
            relative_coord,
            relative_depth,
            rgb24,
            alpha,
    ...
    fn blend_cell_background_absolute<B: Blend>(
        ...
        self.draw.blend_cell_background_absolute(
            absolute_coord,
            absolute_depth,
            rgb24,
            alpha,
        ...
        self.measure_bounds.blend_cell_background_absolute(
            absolute_coord,
            absolute_depth,
            rgb24,
            alpha,
